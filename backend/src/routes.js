...
const motoristaOrcamentoController = require("./controllers/motoristaOrcamento");
...
//routes orcamento
routes.post("/orcamento/:id/resposta", motoristaOrcamentoController.store); //responder o custo do frete, rota privada do motorista
routes.get("/orcamento/:id/resposta", motoristaOrcamentoController.index); //responder o custo do frete, rota privada do motorista
